...
export default function AboutUs() {
  return (
    <div className='bg-[url("/bg-about.avif")] bg-center bg-cover w-full h-auto'> 
        <div className="bg-[#041710] opacity-90 h-full w-full py-10 md:py-16 xl:py-24">
            <WidthContainer>
                <div className="grid grid-cols-1 text-white md:grid-cols-2 gap-10 w-full">
                    <div className="flex justify-center flex-col items-center md:justify-start md:items-start gap-3 w-full md:gap-4 xl:gap-8">
                      <h1 className='uppercase text-center w-10/12 md:w-full md:mx-0 mx-auto text-md md:text-left md:text-lg lg:text-2xl lg:w-10/12 xl:w-10/12 xl:text-3xl 2xl:text-5xl 2xl:leading-[3.5rem]'>
                        A legacy of excellence in luxury real estate
                      </h1>
                      <p className='text-xs sm:text-sm lg:text-lg xl:text-2xl 2xl:w-10/12 2xl:leading-[2.8rem]'>
                      ...
                      <Link href="#" className='w-auto md:w-full'>
                          <Button
                          variant="outline" 
                          className="rounded-md w-full text-white py-1.5 text-center border flex justify-center md:justify-center items-center bg-transparent hover:bg-transparent/25 uppercase text-md px-24 gap-3 md:text- lg:text-2xl lg:px-16 lg:py-2 xl:py-4 xl:text-3xl xl:h-14 xl:w-6/12 ">
