...
const DemacGalleryContent = () => {
  ...
  const prev = () => {
    setCurr((curr) => (curr - 1 + carousels.length) % carousels.length);
  }
  const next = () => {
    setCurr((curr) => (curr + 1 ) % carousels.length);
  }
             ...
             <div className="h-full w-full absolute flex flex-col items-start justify-end pb-20 text-white px-12"> 
              <div className="flex justify-between items-center w-full">
                ...
                <div className="flex items-center justify-center gap-20">
                  <h2 className='2xl:text-3xl font-semibold'>{carousel.label}</h2>
                  <div className="flex items-center justify-center gap-x-2">
                    <MapPin className='size-8 text-white' />
                    <h2 className='2xl:text-3xl font-semibold'>{carousel.location}</h2>
                  </div>
                </div>
                  <ul className="list-disc text-xl">
                    <li className=''>{carousel.desc1}</li>
                    <li className=''>{carousel.desc2}</li>
                  </ul>
                </div>
                 <Link href={carousel.href} className="text-3xl w-auto cursor-pointer">
